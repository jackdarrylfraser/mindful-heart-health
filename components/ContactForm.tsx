...
import { handleContactForm } from "@/actions/send-email";
...
export function ContactForm() {
  ...
  return (
    <form onSubmit={onSubmit} className="flex flex-col gap-4 max-w-md mx-auto my-8 p-4 border rounded bg-white">
